 ...
 * @str: string to be seperated into words
 * @delims: delimitors used to delimit words
 *
 * Return: an array of array of pointers to each word
 */
 ...
 * @ch: char in stream
 * @delims: pointer to null terminated array of delims
 *
...
/**
 * get_word_count - returns the word count of a string
...
/**
 * get_next_word - returns the next word in a string
 * @str: string to get the next word from
 * @delims: delimitors to use to delimit words
 *
 * Return: pointer to ths first char of the next word
 */
